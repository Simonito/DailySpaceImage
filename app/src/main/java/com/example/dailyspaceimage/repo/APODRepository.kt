...
interface APODRepository {
    fun getAPOD(date: LocalDate): ApodDto

    fun getTenAPODsSince(date: LocalDate): List<ApodDto>

    fun getDefaultAPODs(): List<ApodDto> {
        return listOf(
            ApodDto(
                "2023-08-20",
...
class TestingAPODRepo : APODRepository {
    ...
    override fun getAPOD(date: LocalDate): ApodDto {
        throw UnsupportedOperationException(message)
    }

    override fun getTenAPODsSince(date: LocalDate): List<ApodDto> {
        throw UnsupportedOperationException(message)
    }
}